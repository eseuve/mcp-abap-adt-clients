...
export async function check(
  ...
  if (sourceCode) {
    ...
    <chkrun:checkObject adtcore:uri="/sap/bc/adt/ddic/drty/sources/${encodeSapObjectName(name).toLowerCase()}" chkrun:version="${version}">
        <chkrun:artifacts>
            <chkrun:artifact chkrun:contentType="text/plain; charset=utf-8" chkrun:uri="/sap/bc/adt/ddic/drty/sources/${encodeSapObjectName(name).toLowerCase()}/source/main">
